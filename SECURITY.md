...
- **No Warranty**: This software is provided "AS IS" under the Elastic License 2.0 (ELv2), without warranties of any kind. See the [LICENSE](LICENSE) file for full terms.
