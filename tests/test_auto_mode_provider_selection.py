...
class TestAutoModeProviderSelection:
    ...
    def test_gemini_only_fallback_selection(self):
        ...
        try:
            ...
            assert fast_response in ["gemini-flash", "gemini-3.5-flash", "gemini-2.5-flash", "flash"]
            assert balanced in ["gemini-flash", "gemini-3.5-flash", "gemini-2.5-flash", "flash"]
    ...
    def test_openai_only_fallback_selection(self):
        ...
        try:
            ...
            assert extended_reasoning == "gpt-5.3-codex"  # GPT-5.3 Codex prioritized for extended reasoning
            assert fast_response == "gpt-5.2"  # gpt-5.2 comes first in fast response preference
            assert balanced == "gpt-5.3-codex"  # gpt-5.3-codex prioritized for balanced
